...
**SCOPED — not started. Rescheduled from PHASE10 → PHASE11 (zynx, 2026-07-09):**
the carousel isn't needed yet, so PHASE10 was repurposed for two higher-value
authoring features (armature hand-tracking + flip-book layer groups — see
[PHASE10.md]) and this promotional-lobby work moved out one phase. Nothing about
the scope changed in the move; it remains the small, low-risk one. No save-format
bump (touches the lobby, not canvas files).
