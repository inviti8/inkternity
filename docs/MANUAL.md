...
- Open the **FX Library** panel (top toolbar) and pick the **active effect** (single selection). Then choose the **Particle Brush** (magic-wand icon) and **paint** instances onto the layer you're editing — click to place one, or hold/drag to scatter a trail. The brush has **Size** and **Rate** sliders and a **Play on touch** toggle
