 ...
 */
C2PA_API extern
C2PA_DEPRECATED_MSG("Use c2pa_reader_from_context() with an explicit context for new implementations.")
char *c2pa_read_file(const char *path,
                     const char *data_dir);
 ...
 */
C2PA_API extern
C2PA_DEPRECATED_MSG("Use c2pa_builder_add_ingredient_from_stream() with an explicit context for new implementations.")
char *c2pa_read_ingredient_file(const char *path,
                                const char *data_dir);
 ...
 */
C2PA_API extern
C2PA_DEPRECATED_MSG("Use c2pa_builder_from_context() with c2pa_builder_sign_to_stream() for new implementations.")
